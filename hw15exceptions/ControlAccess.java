...
import cz.robodreams.javadeveloper.homeworks.hw15exceptions.exceptions.FileIsNotPresent;
...
public interface ControlAccess {
     ...
     *
     * @param pathToFile cesta k souboru
     * @throws FileIsNotPresent pokud soubor není k dispozici
     */
    void loadFromFile(String pathToFile) throws FileIsNotPresent;
}