...
public interface Exchange {
     ...
     */
    BigDecimal convert(int input, String currency) throws CurrencyNotFoundException, TimeNotAvailableException;
     ...
     * @return converted currency
     */
    BigDecimal convert(LocalDate day, int input, String currency) throws CurrencyNotFoundException, TimeNotAvailableException;
}
