...
13	Zaimplementovat Generika
        přidat další artikl k vypůjčování a to časopisy, noviny, DVD. Tvým úkolem je tento požadavek naimplementovat, nejlépe s využitím generik.

        Refaktorujte třídu Library tak, aby byla generická. Měla by být schopná pracovat s libovolným typem objektů (nejen knihami).
        *     Umožněte třídě Library pracovat s různými typy knih nebo jiných objektů (například DVD, časopisy) pomocí generik.
